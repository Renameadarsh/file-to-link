...
async def private_receive_handler(c: Client, m: Message):
        ...
        try:
            ...
            await c.send_message(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[ InlineKeyboardButton("Jᴏɪɴ ɴᴏᴡ 🔓", url=f"https://t.me/hotstar_vipadarsh{Var.UPDATES_CHANNEL}") ]]
                ),
                parse_mode="HTML"
            )
            return
    ...
    try:
        ...
        msg_text ="""
<i><u>Yiur Link Has Been Generated !</u></i>\n
<b>📂 Fɪʟᴇ ɴᴀᴍᴇ :</b> <i>{}</i>\n
<b>📦 Fɪʟᴇ ꜱɪᴢᴇ :</b> <i>{}</i>\n
<b>📥 Dᴏᴡɴʟᴏᴀᴅ :</b> <i>{}</i>\n
<b>🚸 Nᴏᴛᴇ : Tʜɪs IS ᴘᴇʀᴍᴀɴᴇɴᴛ Lɪɴᴋ, It will never expire</b>\n
<i>© @adarshgoelo5 </i>"""
